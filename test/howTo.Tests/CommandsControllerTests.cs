...
namespace howTo.Tests
{
    public class CommandsControllerTests : IDisposable
    {
        ...
        [Fact]
        public void GetCommandItemsReturnsOneItemWhenDbHasObject()
        {
            //Arrange
        ...
        public void GetCommandItemsReturnsTheCorrectType()
        {
            ...
            //Act
            var result = controller!.GetCommandItems();
            Assert.IsType<ActionResult<IEnumerable<Commands>>>(result);
        }
        //**************************************************
        //*
        ...
        public void GetCommandItemReturnsTheCorrectType()
        {
            ...
            //Assert
            Assert.IsType<ActionResult<Commands>>(result);
        }
        [Fact]
